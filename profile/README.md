...
Connect Git: Authorize GitHub and/or GitLab access for repositories and pipeline runners.
Connect clouds: Add AWS, Azure, and (optionally) OpenClaws accounts/projects with least-privilege roles.
Select a blueprint: Choose from application, data, or platform foundation blueprints.
Provision: Launch environments via pipeline or UI; policies enforce security, cost, and compliance.
Deploy: Use GitOps to promote changes through environments with approvals and automated checks.
